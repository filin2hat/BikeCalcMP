...
- **[LeakCanary](https://square.github.io/leakcanary/)** - Автоматическое обнаружение утечек памяти
  в Android
...
Проект использует **[LeakCanary](https://square.github.io/leakcanary/)** для автоматического
обнаружения утечек памяти в Android версии:
...
**: [SETUP.md - Отладка утечек памяти](./SETUP.md#-отладка-утечек-памяти-с-leakcanary)
