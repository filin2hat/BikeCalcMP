...
LeakCanary - это библиотека для автоматического обнаружения утечек памяти в Android приложениях. Она работает только в debug сборках и не влияет на производительность release версий.
