...
**Практичное приложение для велосипедистов: быстрый подбор давления и расчёт развития передач с наглядными графиками**

</div>

Для чего:
 - Демонстрация навыков работы и знаний современных подходом разработки (KMP, CMP, MVVM-UDF, Clean Architecture, модульной архитектурой).
