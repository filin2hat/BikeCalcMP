 ...
 * Предоставляет возможность выбора между камерной и бескамерной сборкой покрышек.
 * Использует сегментированные кнопки для интуитивного выбора.
 *
 * @param onClick Callback для обработки изменения выбранного типа монтажа
 * @param enabled Флаг активности компонента
 * @param selectedType Текущий выбранный тип монтажа
