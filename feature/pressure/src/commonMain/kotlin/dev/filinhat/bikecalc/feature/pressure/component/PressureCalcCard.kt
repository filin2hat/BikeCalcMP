...
/**
 * Карточка для отображения результата расчета давления велосипеда.
 * Показывает давление для переднего или заднего колеса с возможностью
 * переключения между единицами измерения (BAR, PSI, KPa).
 *
 * @param value Давление в барах для отображения и конвертации
 * @param wheel Тип колеса (переднее или заднее) для определения заголовка
