 ...
 * Показывает список всех сохраненных расчетов давления с возможностью просмотра деталей
 * и удаления отдельных результатов или всех сразу.
 *
 * @param onAction Callback для обработки действий пользователя (удаление результатов)
 * @param savedResults Список сохраненных результатов расчета давления
