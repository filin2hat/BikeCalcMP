 ...
 * Содержит форму для ввода параметров расчета давления велосипеда:
 * вес велосипедиста, вес велосипеда, размер колеса, ширина покрышки и тип монтажа.
 * Отображает результаты расчета в виде карточек с возможностью изменения единиц измерения.
 *
 * @param uiState Текущее состояние экрана с настройками и результатами
 * @param onAction Callback для обработки действий пользователя
